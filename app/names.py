...
def badNames():    # return dictionary
    return {'AA':'rough, cindery lava',
            ...
            'BM':'bowel movement',
            'BMW':'Bavarian Motor Works car company',
            'BO':'pal',
            ...
            'LEK':'v. to gather cocks; n. an Albanian currency',
            ...
            'NIE':'v. (obs.) to draw near (also NIGH; pr.p. NYING)',
            'NIH':'National Institutes of Health',
            'NIL':'n. nothing',
            'NIM':'v. to take or steal (n. NIMMER)',
            'NIP':'v. to pinch',
            'NIS':'n. a goblin in Scandinavian folklore (pl. NISSES)',
            'NIT':'n. the egg of a louse or other parasite',
            'NIX':'v. to veto or cancel',
            'NM':'never mind',
            'NO':'negative reply',
            'NOB':'n. a person of high social rank',
            'NOD':'v. to move the head in greeting or agreement (n. NODDER)',
            ...
            'NUR':'n. a knot on a tree (also KNUR, NURR)',
            'NUS':'plural of NU n. a Grek letter',
            'NUT':'v. to gather nuts (n. NUTTER)',
            'NVM':'nevermind',
            'NYE':'v. (obs.) to draw near (also NIE, NIGH; pr.p. NYING)',
            'NYS':'conj. (Spens.) is not',
            'OAF':'n. a lout; an idiot (pl. OAFS, OAVES)',
            ...
            'OCH':'interj. (Scots.) expressing impatience (also ACH)',
            'OD':'hypothetical force of natural power',
            'ODA':'n. a room in a harem',
            'ODD':'adj. strange; unpaired; n. a strange person',
            'ODE':'n. an elaborate lyric addressed to someone or something',
            'ODS':'plural of OD n. a hypothetical force of nature',
            'OE':'Faroean wind',
            ...
            'OHO':'n. an expression of triumph or surprise',
            'OHS':'present tense of OH v. to exclaim in surprise',
            'OI':'intj. expressing dismay (oy)',
            'OIK':'n. an inferior person',
            'OIL':'v. to grease or lubricate (n. OILER)',
            'OIS':'plural of OI n. a bloke',
            'OK':'okay',
            'OKA':'',
            'OKA':'n. a Turkish weight (also OKE)',
            'OKE':'n. a Turkish weight (also OKA)',
            'OLD':'adj. long-lasting; n. an individual of a specified age',
            ...
            'ONE':'the number "1"; an individual person or thing (n. ONER)',
            'ONO':'n. a fish',
            ...
            'OOR':'(Scots.) same as OUR pron. belonging to us',
            ...
            'PET':'v. to caress with the hand (n. PETTER)',
            ...
            'PIE':'v. to reduce to confusion (pr.p. PIEING or PIING)',
            'PIG':'v. (slang) to eat greedily',
            'PIN':'v. to fasten with a pin (thin piece of metal)',
            'PIP':'v. to offend or disgust',
            'PIR':'n. a Muslim title of honour',
            'PIS':'plural of PI n. a Greek letter',
            'PIT':'v. to mark with cavities',
            'PIU':'adv. (music) more',
            'PIX':'n. a box in which eucharistic bread is kept (also PYX)',
            'PLU':'n. a beaver pelt',
            'PLY':'v. to bend or fold (n. PLIER, PLYER)',
            'PLZ':'please',
            ...
            'POO':'v. to defecate',
            'POP':'v. to make a mild explosive sound (n. POPPER)',
            ...
            'PRY':'v. to look into private matters (n. PRIER, PRYER)',
            'PS':'post script',
            ...
            'PUN':'v. to make a play on words (n. PUNNER, PUNSTER)',
            ...
            'PYE':'v. to reduce to confusion (also PIE; pr.p. PYEING)',
            'PYX':'v. to test the weight of a coin in a special box',
            'QAT':'n. an East African shrub (also KAT, KHAT)',
            'QI':'vital life-sustaining energy force',
            'QIN':'n. a Chinese zither with silken strings (also GUQIN)',
            ...
            'RAJ':'n. sovereignty',
            'RAM':'v. to push or cram down hard (n. RAMMER)',
            'RAN':'past tense of RUN v. to move quickly',
            'RAP':'v. to strike sharply (n. RAPPER)',
            'RAS':'n. an Ethiopian prince',
            'RAT':'v. to hunt rats (n. RATTER)',
            'RAV':'n. a rabbi, esp one in authority; a teacher or mentor',
            'RAW':'n. a blister',
            'RAX':'v. to stretch',
            ...
            'RED':'adj. of the colour of blood v. to put in order (also REDD)',
            ...
            'ROC':'n. a large bird of Arabian legend (also ROK, RUC, RUKH)',
            'ROD':'v. to push a rod through',
            'ROE':'n. a mass of fish eggs (adj. ROED)',
            'ROK':'n. a large bird of Arabian legend (also ROC, RUC, RUKH)',
            'ROM':'n. a gypsy man (pl. ROMS, ROMA)',
            'ROO':'n. a kangaroo',
            'ROT':'v. to decay',
            'ROW':'v. to propel through water with oars (n. ROWER)',
            'RUB':'v. to apply friction',
            'RUC':'n. a large bird of Arabian legend (also ROC, RUK, RUKH)',
            'RUD':'v. to redden',
            'RUE':'v. to regret (n. RUER; pr.p. RUING, RUEING)',
            ...
            'SAR':'v. (Scots.) to savour (pa.t. SARED, pr.p. SARING)',
            'SAT':'past tense of SIT v. to rest on the buttocks',
            'SAU':'n. a Vietnamese coin; (also XU; pl. SAU)',
            'SAV':'n. a saveloy',
            'SAW':'v. to use a cutting tool (n. SAWER)',
            'SAX':'n. a chopper for trimming slate (also ZAX, ZEX)',
            'SAY':'v. to speak n. SAYER; pa.t. SED, SAID, SAYED)',
            'SAZ':'n. a stringed instrument of N. Africa',
            'SEA':'n. an ocean',
            'SEC':'n. a secant',
            'SED':'past tense (Milton) of SAY v. to speak',
            ...
            'STD':'sezually transmitted disease',
            'STY':'v. to keep in a sty (pa.t. STIED, STYED)',
            'SUB':'v. to substitute; to subscribe',
            'SUD':'n. froth of soapy water (usually in pl. SUDS)',
            'SUE':'v. to prosecute at law (n. SUER; pr.p. SUING)',
            'SUG':'v. to attempt to sell a product while purporting to be engaged in market research',
            'SUI':'pron. himself, herself, itself',
            'SUK':'n. a market place (also SOOK, SOUK, SUKH, SUQ,), also \'suck\'',
            'SUM':'v. to add, make up the total of',
            'SUN':'v. to expose to the sun\'s rays',
            'SUP':'v. to take liquid into the mouth',
            'SUQ':'n. a marketplace (also SOOK, SOUK, SUK, SUKH)',
            'SUR':'prep. (French) on, above',
            'SUS':'v. to arrest for suspicious behaviour (pl. SUSES, SUSSES)',
            'SUX':'sucks',
            ...
            'TAJ':'n. a crown',
            'TAK':'v. (Scots.) to take (pa.t. TOOK; pa.p. TAKEN)',
            'TAM':'a cap with a broad, circular flat top',
            'TAN':'adj. brown from the sun\'s rays; v. to convert hide into leather (n. TANNER)',
            'TAO':'n. a path of virtuous conduct in Japanese philosophy',
            'TAP':'v. to knock gently (n. TAPPER)',
            'TAR':'v. to coat with bitumen (n. TARRIER)',
            ...
            'TOD':'v. to yield a tod, an old wool weight (also TODDE)',
            ...
            'TYE':'v. to wash in a tye trough (pr.p. TYEING)',
            ...
            'UMM':'interj. expressing doubt or hesitation (also UM)',
            'UMP':'v. to umpire',
            'UMS':'vf. UM, to say um',
            'UMU':'n. an oven',
            'UN':'one',
            ...
            'UVA':'n. a grape or grape-like berry (pl. UVAE, UVAS)',
            'VAC':'v. to clean with a vacuum cleaner (pa.t. VACKED)',
            'VAE':'n. in Orkney or Shetland, a bay or creek (also VOE)',
            'VAG':'n. (slang) vagina, v. to arrest for vagrancy',
            ...
            'VAV':'n. a Hebrew letter (also VAW, WAW)',
            'VAW':'n. a Hebrew letter (also VAV, WAW)',
            'VEE':'n. the letter "V"',
            ...
            'VIG':'n. a vigorish, a charge paid to a bookie on a bet',
            'VIM':'n. energy, vigour',
            'VIN':'n. (French) wine',
            'VIS':'n. (Latin) a force',
            'VLY':'n. a swamp ',
            'VOE':'n. in Orkney or Shetland, a bay or creek (also VAE) ',
            'VOL':'n. (heraldry) two wings displayed and conjoined',
            'VOR':'v. (Shakesp.) to warn ',
            'VOW':'v. to make a solemn promise (n. VOWER)',
            ...
            'WAE':'n. (Scots) woe',
            'WAG':'v. to move from side to side (n. WAGGER)',
            'WAI':'n. water ',
            ...
            'WAW':'n. a wave (also WAWE); a Hebrew letter (also VAV, VAW)',
            'WAX':'v. to treat with a fatty substance; to grow larger (n. WAXER)  ',
            'WAY':'v. (Spens.) to journey',
            'WEB':'v. to envelop with a net-like structure',
            'WED':'v. to marry (n. WEDDER)',
            'WEE':'adj. small; v. to urinate',
            'WEM':'n. the womb or belly (also WAME, WE(A)MB)',
            'WEN':'n. a sebaceous cyst',
            'WET':'adj. saturated; v. to moisten (WETTER; WETTED)',
            'WEX':'v. (obs.) to wax (also WEXE)',
            'WEY':'n. a measure for dry goods',
            'WHA':'pron. who',
            'WHO':'pron. used in referring to a person',
            'WHY':'n. the reason or cause of something (pl. WHYS)',
            ...
            'WOK':'n. a frying pan used in Chinese cooking (also WOCK)',
            'WON':'v. to dwell',
            ...
            'WRY':'adj. contorted; v. to give a twist to (pa.t. WRIED)',
            'WTF':'what the F***?',
            'WUD':'v. (Scots.) to cover with trees',
            'WUS':'n. (Welsh) term to address a companion',
            'WWW':'World Wide Web',
            'WYE':'n. the letter "Y"',
            'WYN':'n. a rune equal to modern "W" (also WYNN)',
            'XI':'Greek letter',
            ...
            'YAH':'n. an affirmative vote (also YEA, YEH, YEAH, YES)',
            'YAK':'v. to talk persistently (also YACK; n. YAKKER)',
            'YAM':'n. a sweet potato',
            'YAP':'v. to bark sharply or constantly (n. YAPPER, YAPSTER)',
            'YAR':'adj. nimble (also YARE)',
            'YAW':'v. to deviate from a course',
            'YAY':'n. an affirmative vote (also YAH, YEA, YEH, YEAH, YES)',
            'YE':'you',
            'YEA':'n. an affirmative vote (also YAH, YAY, YEAH, YEH, YES)',
            'YEH':'adv. (colloq.) yes (also YEAH)',
            'YEN':'v. to desire or yearn',
            'YEP':'n. an affirmative reply (also YUP, YES)',
            'YES':'v. to give an affirmative reply (pl. YESES, YESSES)',
            'YET':'adv. in addition, besides',
            'YEW':'n. a type of evergreen tree',
            'YEX':'v. to hiccup or belch (also YESK)',
            'YGO':'past tense (Spens.) of go v. to move along (also YGOE)',
            ...
            'YUS':'plural of YU n. a precious jade',
            'ZA':'pizza',
            'ZAG':'v. to change direction on a zig-zag course (also ZIG)',
            ...
            'ZHO':'n. a cross between a yak and a cow (also ZO, DSO, DZO, DZHO)',
            'ZIG':'v. to change direction on a zig-zag course (also ZAG)',
